...
void StringWrite(String *this, int fd) { write(fd, this->buffer, this->size); }
...
size_t StringSize(const String *this) { return this->size; }

size_t StringCapacity(const String *this) { return this->capacity; }
